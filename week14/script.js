...
//https://github.com/Pai-Chan/Keyboard-Piano
...
function preload() {
	sound_a = loadSound('assets/c3.ogg');
	sound_s = loadSound('assets/d3.ogg');
	sound_d = loadSound('assets/e3.ogg');
	sound_f = loadSound('assets/f3.ogg');
	sound_j = loadSound('assets/g3.ogg');
	sound_k = loadSound('assets/a3.ogg');
	sound_l = loadSound('assets/b3.ogg');
	sound_semicolon = loadSound('assets/ha4.ogg');
}
